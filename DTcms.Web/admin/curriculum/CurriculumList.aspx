<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurriculumList.aspx.cs" Inherits="DTcms.Web.admin.curriculum.CurriculumList" %>
...
<body>
  ...
  <%--  <div>--%>
    <asp:Calendar ID="CalPlan" runat="server"  BorderColor="#3366CC"
            ...
            ForeColor="#708090" Height="90%" Width="90%" OnDayRender="CalPlan_DayRender" BorderWidth="1px" Font-Bold="True" NextMonthText="下月" PrevMonthText="上月" ShowGridLines="True" Title="会议日程">
