...
namespace Senparc.Weixin.MP.Test.CommonAPIs
{
    ...
    public partial class CommonApiTest
    {
            ...
            get
            {
                if (_appConfig == null)
                {
                    ...
                    else
                    {
                        _appConfig = new
                        {
                            AppId = "wx06687d6a1016b622", //换成你的信息
                            Secret = "1f24ea57651b40125ed4adcabf3191e1",//换成你的信息
                            MchId = "1567713901",//换成你的信息
                            TenPayKey = "3156LX8edDQA9xvhr3w48zJLmgsoErSb",//换成你的信息
                            TenPayCertPath = @"C:\weixincert\apiclient_cert.p12",//换成你的信息
                        };
                    }
                }
                return _appConfig;
        ...
        public string _tenPayKey
        {
            get { return AppConfig.TenPayKey; }
        }

        public string _tenPayCertPath
        {
