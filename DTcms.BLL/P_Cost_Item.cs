...
namespace DTcms.BLL
{
	...
	{
		private readonly DTcms.DAL.P_Cost_Item dal=new DTcms.DAL.P_Cost_Item();
		public P_Cost_Item()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<DTcms.Model.P_Cost_Item> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DTcms.Model.P_Cost_Item> DataTableToList(DataTable dt)
		{
			List<DTcms.Model.P_Cost_Item> modelList = new List<DTcms.Model.P_Cost_Item>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DTcms.Model.P_Cost_Item model;
