...
namespace DTcms.BLL
{
	...
	{
		private readonly DTcms.DAL.S_Student_Info dal=new DTcms.DAL.S_Student_Info();
		...
		/// 获得数据列表
		/// </summary>
		public List<DTcms.Model.S_Student_Info> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DTcms.Model.S_Student_Info> DataTableToList(DataTable dt)
		{
			List<DTcms.Model.S_Student_Info> modelList = new List<DTcms.Model.S_Student_Info>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DTcms.Model.S_Student_Info model;
